...
export default function Page() {
  ...
  return (
    <div className="min-h-screen bg-zinc-50 dark:bg-black flex flex-col items-center py-16 px-4">
      <h1 className="text-3xl font-bold text-center mb-8 text-black dark:text-zinc-50">Consulta Médicos Online</h1>
      <h2 className="text-xl font-semibold mb-6 text-zinc-700 dark:text-zinc-200">Escolha seu plano</h2>
      {loading ? (
