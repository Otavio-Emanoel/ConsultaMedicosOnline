        ...
        {!loading && dashboard && (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="rounded-xl border p-4">
              ...
              <button
                className="mb-2 flex items-center gap-2 px-4 py-2 rounded-lg bg-gradient-to-r from-blue-600 to-blue-400 text-white text-xs font-semibold shadow hover:from-blue-700 hover:to-blue-500 transition"
                onClick={() => router.push('/assinante/perfil')}
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M5.121 17.804A13.937 13.937 0 0112 15c2.5 0 4.847.655 6.879 1.804M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                </svg>
                Acessar área de perfil
              </button>
              {dashboard.usuario ? (
            ...
            <div className="rounded-xl border p-4">
              ...
              <button
                className="mb-2 flex items-center gap-2 px-4 py-2 rounded-lg bg-gradient-to-r from-green-600 to-green-400 text-white text-xs font-semibold shadow hover:from-green-700 hover:to-green-500 transition"
                onClick={() => router.push('/assinante/assinaturas')}
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
            ...
            <div className="rounded-xl border p-4">
              ...
              <button
                className="mb-2 flex items-center gap-2 px-4 py-2 rounded-lg bg-gradient-to-r from-purple-600 to-purple-400 text-white text-xs font-semibold shadow hover:from-purple-700 hover:to-purple-500 transition"
                onClick={() => router.push('/assinante/dependentes')}
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
